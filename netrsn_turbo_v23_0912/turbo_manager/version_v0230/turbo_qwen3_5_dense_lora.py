...
def apply_dense_lora_patch() -> None:
    from netrsn_turbo.turbo.version_v0230.vllm.lora import (
        model_manager as model_manager_patch,
    )
    from netrsn_turbo.turbo.version_v0230.vllm.lora import (
        worker_manager as worker_manager_patch,
    )
    from netrsn_turbo.turbo.version_v0230.vllm_ascend.attention import (
        attention_v1 as attention_patch,
    )
    from netrsn_turbo.turbo.version_v0230.vllm_ascend.lora import (
