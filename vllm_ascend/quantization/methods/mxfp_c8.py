...
class AscendC8MXFPKVCacheAttentionMethod(AscendAttentionScheme):
    ...
    This method changes the cache storage path: K/V are cached as FP8 E4M3
    and their per-32-element E8M0 scales are stored in extra cache tensors.
    """
    ...
    def create_weights(self, layer: torch.nn.Module) -> None:
        ...
        if hasattr(layer, "impl"):
            ...
            layer.impl._v_scale_cache_ref = None
        ...
        # Segment weights by tensor-parallel rank while loading.
    ...
    def process_weights_after_loading(self, layer: torch.nn.Module) -> None:
        ...
        scale = torch.exp2(exponent).to(target_dtype)
        layer.v_cache_scale_float = torch.nn.Parameter(scale, requires_grad=False)
        layer.v_cache_scale_float_reciprocal = torch.nn.Parameter(1 / scale, requires_grad=False)
